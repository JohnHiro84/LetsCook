Production Readme - Let's Cook!
A little Recipe Sharing Application. Built with ?? by Alexander Yambao

Brief explanation of what the app is and does

  Let's Cook! is a Recipe Sharing Application where users can upload recipes for others to view.
  Users can edit, delete, add ingredients, directions, comments and likes to particular recipes.
...
Discussion of the technologies used
...
Delve deep into ~2 features that show off your technical abilities. Discuss both the challenges faced and your brilliant solutions.
  ...
  immediately render the new recipe title, description and tags.

  Another Challenge I faced was in trying to pass along the session.username
